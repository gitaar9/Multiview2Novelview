...
# python evaler.py --dataset chair --data_id_list ./testing_tuple_lists/id_chair_elevation_small.txt --train_dir ./checkpoints/chair_checkpoint/ --loss True --write_summary True --summary_file log_chair.txt --plot_image True --output_dir img_chair
# python evaler.py --dataset chair --data_id_list ./testing_tuple_lists/id_chair_elevation_small.txt --checkpoint ./checkpoints/chair_checkpoint/model-1 --loss True --write_summary True --summary_file log_chair.txt --plot_image True --output_dir img_chair